...
export const mockCourses = [
  { id: 1, name: 'Компьютерын архитектур', code: 'F.CS301', description: 'CPU, RAM, ROM, санах ойн бүтэц' },
];

export const mockTopics = [
  { id: 13, courseId: 1, name: 'Үндсэн санах ой (RAM)', description: 'DRAM, SRAM, SDRAM' },
  { id: 14, courseId: 1, name: 'ROM санах ой', description: 'MASK ROM, PROM, EPROM, EEPROM' },
  { id: 15, courseId: 1, name: 'CPU ба RAM урсгал', description: 'Data flow, Control flow' },
  { id: 16, courseId: 1, name: 'Санах ойн хаяглалт', description: 'Хаяглалтын аргууд' },
];
...
export const mockQuestionBank = [
  ...
  // 3. Text answer
  {
    ...
    courseId: 1,
    topicId: 13,
    question: '___ нь системийн үндсэн шинжлэх (bus) цагтай уялдаж, өгөгдөл унших, бичих үйлдлийг яг цагийн дохионд нийцүүлэн хийдэг. Энэ нь хурд, тогтвортой ажиллагааг сайжруулдаг.',
    type: 'text_answer',
  ...
  // 29. Зураг бүхий олон сонголттой
  {
    ...
    courseId: 1,
    topicId: 16,
    question: 'Зурганд харуулсан компьютерын бүрэлдэхүүн хэсгүүдээс аль нь санах ой вэ?',
