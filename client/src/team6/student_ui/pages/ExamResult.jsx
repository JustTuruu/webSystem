      ...
      questions.forEach(q => {
        ...
        if (userAnswer) {
          ...
          if (q.type === 'multiple_choice') {
            ...
            isCorrect = q.correctAnswers.some(ans => ans.toLowerCase().trim() === userLower) ||
                       (q.acceptableAnswers && q.acceptableAnswers.some(ans => ans.toLowerCase().trim() === userLower));
          }
          
          if (isCorrect) {
            totalScore += (q.marks || 5); // Хэрэв marks байхгүй бол default 5 оноо
            correct++;
          }
        }
      });
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Үр дүн олдсонгүй</h2>
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
          ...
          <div className={`p-8 text-center ${passed ? 'bg-green-600' : 'bg-red-600'} text-white`}>
            ...
            <p className="text-lg opacity-90">
              {passed ? 'Та шалгалтыг амжилттай давлаа' : 'Шалгалтыг давж чадсангүй'}
            </p>
          </div>
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              <div className="inline-block">
                <div className="text-7xl font-bold text-gray-900 mb-2">
                  {score}
                  <span className="text-3xl text-gray-500">/{exam.totalMarks}</span>
                </div>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <span className="text-gray-600 font-medium">Үргэлжилсэн хугацаа:</span>
