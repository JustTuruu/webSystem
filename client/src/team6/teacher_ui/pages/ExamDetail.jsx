...
const ExamDetail = () => {
  ...
  const getStatusBadge = (status) => { 
    ...
    return (
      <span className={`px-4 py-2 rounded-full text-sm font-medium ${badges[status]}`}>
        {labels[status]}
      </span>
    );
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto"> 
        {/* Header */}
        <div className="mb-6">
          <Link to="/team6/teacher" className="text-gray-600 hover:text-gray-900 mb-4 inline-block">
            ← Буцах
          </Link>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-6">Шалгалтын мэдээлэл</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-between border-b border-gray-100 pb-3">
                ...
                <span className="font-semibold text-gray-900">{formatDate(exam.endDate)}</span>
              </div>
              <div className="flex justify-between border-b border-gray-100 pb-3">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between border-b border-gray-100 pb-3">
                ...
                <span className="font-semibold text-gray-900">{exam.createdBy}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {stats && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-3xl font-bold text-gray-900 mb-1">{stats.completedStudents}</div>
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <div className="text-3xl font-bold text-gray-900 mb-1">{stats.passingRate}%</div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900">Вариантууд ({variants.length})</h2>
            <Link
