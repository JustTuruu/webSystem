...
const CreateVariant = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('New variant:', { name: variantName, questions });
    alert('Хувилбар амжилттай үүсгэлээ!');
    navigate(`/team6/teacher/courses/${course_id}/exams/${exam_id}/variants`);
  };
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Хувилбар үүсгэх</h1>
